...
#include "Content\LabeledCubeRenderer.h"
...
{
    class SampleHoloLensMain : public DX::IDeviceNotify
    {
    public:
        SampleHoloLensMain(std::shared_ptr<DX::DeviceResources> const& deviceResources);
        ~SampleHoloLensMain();
    ...
    private:
        ...
        void OnFoundAnchors(winrt::Windows::Foundation::Collections::IObservableMap<winrt::hstring, winrt::SampleHoloLens::AnchorVisual> const& sender, winrt::Windows::Foundation::Collections::IMapChangedEventArgs<winrt::hstring> const& args);
        ...
        std::unordered_map<winrt::hstring, std::unique_ptr<LabeledCubeRenderer>> m_anchorVisuals;
